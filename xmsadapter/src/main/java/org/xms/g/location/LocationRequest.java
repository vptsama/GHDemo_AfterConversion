 ...
 * Combination of com.google.android.gms.location.LocationRequest and com.huawei.hms.location.LocationRequest.<br/>
...
public final class LocationRequest extends org.xms.g.utils.XObject implements android.os.Parcelable {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.google.android.gms.location.LocationRequest()com.huawei.hms.location.LocationRequest()
     */
