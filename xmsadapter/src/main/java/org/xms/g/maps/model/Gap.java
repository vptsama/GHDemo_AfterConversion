 ...
 * Combination of com.google.android.gms.maps.model.Gap and com.huawei.hms.maps.model.Gap.<br/>
...
public final class Gap extends org.xms.g.maps.model.PatternItem {
    ...
    /**
     * org.xms.g.maps.model.Gap.Gap(org.xms.g.utils.XBox) constructor of Gap<br/>
    ...
    /**
     * org.xms.g.maps.model.Gap.Gap(float) constructor of Gap<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 float
    ...
    /**
     * org.xms.g.maps.model.Gap.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
