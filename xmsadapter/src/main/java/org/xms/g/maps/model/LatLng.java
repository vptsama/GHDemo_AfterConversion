 ...
 * Combination of com.google.android.gms.maps.model.LatLng and com.huawei.hms.maps.model.LatLng.<br/>
...
public final class LatLng extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.LatLng.LatLng(org.xms.g.utils.XBox) constructor of LatLng<br/>
    ...
    /**
     * org.xms.g.maps.model.LatLng.LatLng(double,double) constructor of LatLng<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 double
    ...
    /**
     * org.xms.g.maps.model.LatLng.getLongitude() Longitude, in degrees. This value is in the range [-180, 180).<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.LatLng.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.LatLng.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
