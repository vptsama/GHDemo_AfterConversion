 ...
 * Combination of com.google.android.gms.maps.model.LatLngBounds and com.huawei.hms.maps.model.LatLngBounds.<br/>
...
public final class LatLngBounds extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.LatLngBounds.LatLngBounds(org.xms.g.utils.XBox) constructor of LatLngBounds<br/>
    ...
    /**
     * org.xms.g.maps.model.LatLngBounds.LatLngBounds(org.xms.g.maps.model.LatLng,org.xms.g.maps.model.LatLng) constructor of LatLngBounds<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
    ...
    /**
     * org.xms.g.maps.model.LatLngBounds.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.LatLngBounds.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
 ...
 * Combination of com.google.android.gms.maps.model.LatLngBounds.Builder and com.huawei.hms.maps.model.LatLngBounds.Builder.<br/>
