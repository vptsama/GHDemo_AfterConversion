 ...
 * Combination of com.google.android.gms.maps.model.GroundOverlay and com.huawei.hms.maps.model.GroundOverlay.<br/>
 * com.google.android.gms.maps.model.GroundOverlay: A ground overlay is an image that is fixed to a map. A ground overlay has the following properties:<br/>
...
public final class GroundOverlay extends org.xms.g.utils.XObject {
    ...
    /**
     * org.xms.g.maps.model.GroundOverlay.GroundOverlay(org.xms.g.utils.XBox) constructor of GroundOverlay<br/>
    ...
    /**
     * org.xms.g.maps.model.GroundOverlay.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     ...
     * 
     * @param  param0 the param should be instanceof maps.model.LatLngBounds
     */
