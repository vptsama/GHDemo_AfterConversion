 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaLocation and com.huawei.hms.maps.model.StreetViewPanoramaLocation.<br/>
...
public class StreetViewPanoramaLocation extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLocation.StreetViewPanoramaLocation(org.xms.g.utils.XBox) constructor of StreetViewPanoramaLocation<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLocation.StreetViewPanoramaLocation(org.xms.g.maps.model.StreetViewPanoramaLink[],org.xms.g.maps.model.LatLng,java.lang.String) constructor of StreetViewPanoramaLocation<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 maps.model.StreetViewPanoramaLink[]
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLocation.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLocation.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
