...
/**
 * xms  Cap that is squared off exactly at the start or end vertex of a Polyline with solid stroke pattern ..<br/>
 * Combination of com.google.android.gms.maps.model.ButtCap and com.huawei.hms.maps.model.ButtCap.<br/>
...
public final class ButtCap extends org.xms.g.maps.model.Cap {
    ...
    /**
     * org.xms.g.maps.model.ButtCap.ButtCap(org.xms.g.utils.XBox) constructor of ButtCap<br/>
    ...
    /**
     * org.xms.g.maps.model.ButtCap.ButtCap() constructor of ButtCap<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     */
    ...
    /**
     * org.xms.g.maps.model.ButtCap.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     ...
     * @return cast maps.model.ButtCap object
     */
