 ...
 * Combination of com.google.android.gms.maps.model.CustomCap and com.huawei.hms.maps.model.CustomCap.<br/>
...
public final class CustomCap extends org.xms.g.maps.model.Cap {
    ...
    /**
     * org.xms.g.maps.model.CustomCap.CustomCap(org.xms.g.utils.XBox) constructor of CustomCap<br/>
    ...
    /**
     * org.xms.g.maps.model.CustomCap.CustomCap(org.xms.g.maps.model.BitmapDescriptor,float) constructor of CustomCap<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 maps.model.BitmapDescriptor
     * @param  param1 float
     */
    ...
    /**
     * org.xms.g.maps.model.CustomCap.CustomCap(org.xms.g.maps.model.BitmapDescriptor) constructor of CustomCap<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 maps.model.BitmapDescriptor
    ...
    /**
     * org.xms.g.maps.model.CustomCap.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
