 ...
 * Combination of com.google.android.gms.maps.model.Tile and com.huawei.hms.maps.model.Tile.<br/>
...
public final class Tile extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.Tile.Tile(org.xms.g.utils.XBox) constructor of Tile<br/>
    ...
    /**
     * org.xms.g.maps.model.Tile.Tile(int,int,byte[]) constructor of Tile<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 int
