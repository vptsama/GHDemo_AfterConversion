...
/**
 * xms An immutable class representing a dot used in the stroke pattern for a Polyline or the outline of a Polygon or Circle..<br/>
 * Combination of com.google.android.gms.maps.model.Dot and com.huawei.hms.maps.model.Dot.<br/>
...
public final class Dot extends org.xms.g.maps.model.PatternItem {
    ...
    /**
     * org.xms.g.maps.model.Dot.Dot(org.xms.g.utils.XBox) constructor of Dot<br/>
    ...
    /**
     * org.xms.g.maps.model.Dot.Dot() constructor of Dot<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     */
    ...
    /**
     * org.xms.g.maps.model.Dot.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
