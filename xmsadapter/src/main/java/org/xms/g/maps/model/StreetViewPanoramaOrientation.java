 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaOrientation and com.huawei.hms.maps.model.StreetViewPanoramaOrientation.<br/>
...
public class StreetViewPanoramaOrientation extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaOrientation.StreetViewPanoramaOrientation(org.xms.g.utils.XBox) constructor of StreetViewPanoramaOrientation<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaOrientation.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaOrientation.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaOrientation.Builder and com.huawei.hms.maps.model.StreetViewPanoramaOrientation.Builder.<br/>
