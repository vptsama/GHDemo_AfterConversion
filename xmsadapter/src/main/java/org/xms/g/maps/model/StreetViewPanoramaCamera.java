 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaCamera and com.huawei.hms.maps.model.StreetViewPanoramaCamera.<br/>
...
public class StreetViewPanoramaCamera extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaCamera.StreetViewPanoramaCamera(org.xms.g.utils.XBox) constructor of StreetViewPanoramaCamera<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaCamera.builder() Creates a builder for a Street View panorama camera.<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.google.android.gms.maps.model.StreetViewPanoramaCamera.builder(): <a href="https://developers.google.com/android/reference/com/google/android/gms/maps/model/StreetViewPanoramaCamera#public-static-streetviewpanoramacamera.builder-builder">https://developers.google.com/android/reference/com/google/android/gms/maps/model/StreetViewPanoramaCamera#public-static-streetviewpanoramacamera.builder-builder</a><br/>
     * com.huawei.hms.maps.model.StreetViewPanoramaCamera.builder()
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaCamera.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaCamera.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaCamera.Builder and com.huawei.hms.maps.model.StreetViewPanoramaCamera.Builder.<br/>
