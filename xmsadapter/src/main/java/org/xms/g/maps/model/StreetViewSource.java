 ...
 * Combination of com.google.android.gms.maps.model.StreetViewSource and com.huawei.hms.maps.model.StreetViewSource.<br/>
...
public final class StreetViewSource extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.StreetViewSource.StreetViewSource(org.xms.g.utils.XBox) constructor of StreetViewSource<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewSource.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewSource.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
