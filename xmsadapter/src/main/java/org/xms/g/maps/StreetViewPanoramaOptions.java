 ...
 * Combination of com.google.android.gms.maps.StreetViewPanoramaOptions and com.huawei.hms.maps.StreetViewPanoramaOptions.<br/>
...
public final class StreetViewPanoramaOptions extends org.xms.g.utils.XObject {
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaOptions.StreetViewPanoramaOptions(org.xms.g.utils.XBox) constructor of StreetViewPanoramaOptions<br/>
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaOptions.StreetViewPanoramaOptions() constructor of StreetViewPanoramaOptions<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     */
     ...
     * @return the return object is java.lang.Integer
     */
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.google.android.gms.maps.StreetViewPanoramaOptions.position(org.xms.g.maps.model.LatLng): <a href="https://developers.google.com/android/reference/com/google/android/gms/maps/StreetViewPanoramaOptions#public-streetviewpanoramaoptions-position-latlng-position">https://developers.google.com/android/reference/com/google/android/gms/maps/StreetViewPanoramaOptions#public-streetviewpanoramaoptions-position-latlng-position</a><br/>
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaOptions.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaOptions.writeToParcel(android.os.Parcel,int) writeToParcel<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
