 ...
 * Combination of com.google.android.gms.maps.model.StreetViewPanoramaLink and com.huawei.hms.maps.model.StreetViewPanoramaLink.<br/>
...
public class StreetViewPanoramaLink extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLink.StreetViewPanoramaLink(org.xms.g.utils.XBox) constructor of StreetViewPanoramaLink<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLink.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.StreetViewPanoramaLink.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
