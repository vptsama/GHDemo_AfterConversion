 ...
 * Combination of com.google.android.gms.maps.StreetViewPanoramaView and com.huawei.hms.maps.StreetViewPanoramaView.<br/>
...
public class StreetViewPanoramaView extends android.widget.FrameLayout implements org.xms.g.utils.XGettable {
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaView.StreetViewPanoramaView(android.content.Context) constructor of StreetViewPanoramaView<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 android.content.Context
     */
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaView.StreetViewPanoramaView(android.content.Context,android.util.AttributeSet) constructor of StreetViewPanoramaView<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 android.content.Context
     * @param  param1 android.util.AttributeSet
     */
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaView.StreetViewPanoramaView(android.content.Context,android.util.AttributeSet,int) constructor of StreetViewPanoramaView<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 android.content.Context
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaView.StreetViewPanoramaView(android.content.Context,org.xms.g.maps.StreetViewPanoramaOptions) constructor of StreetViewPanoramaView<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 android.content.Context
     * @param  param1 maps.StreetViewPanoramaOptions
     */
     ...
     * @param  param0 the param should be instanceof maps.OnStreetViewPanoramaReadyCallback
     */
    ...
    /**
     * org.xms.g.maps.StreetViewPanoramaView.setHInstance(java.lang.Object) setHInstance<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     * @param  param0 the param should be instanceof java.lang.Object
