 ...
 * Combination of com.google.android.gms.maps.model.MapStyleOptions and com.huawei.hms.maps.model.MapStyleOptions.<br/>
...
public final class MapStyleOptions extends org.xms.g.utils.XObject implements android.os.Parcelable {
    ...
    /**
     * org.xms.g.maps.model.MapStyleOptions.MapStyleOptions(org.xms.g.utils.XBox) constructor of MapStyleOptions<br/>
    ...
    /**
     * org.xms.g.maps.model.MapStyleOptions.MapStyleOptions(java.lang.String) constructor of MapStyleOptions<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     ...
     * @return the return object is maps.model.MapStyleOptions
     */
