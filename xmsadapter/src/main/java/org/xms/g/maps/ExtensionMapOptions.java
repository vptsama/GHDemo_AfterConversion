 ...
 * Combination of com.google.android.gms.maps.GoogleMapOptions and com.huawei.hms.maps.HuaweiMapOptions.<br/>
...
public final class ExtensionMapOptions extends org.xms.g.utils.XObject {
    ...
    /**
     * org.xms.g.maps.ExtensionMapOptions.ExtensionMapOptions(org.xms.g.utils.XBox) constructor of ExtensionMapOptions<br/>
    ...
    /**
     * org.xms.g.maps.ExtensionMapOptions.ExtensionMapOptions() constructor of ExtensionMapOptions<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     */
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.google.android.gms.maps.GoogleMapOptions.camera(org.xms.g.maps.model.CameraPosition): <a href="https://developers.google.com/android/reference/com/google/android/gms/maps/GoogleMapOptions#public-googlemapoptions-camera-cameraposition-camera">https://developers.google.com/android/reference/com/google/android/gms/maps/GoogleMapOptions#public-googlemapoptions-camera-cameraposition-camera</a><br/>
     * com.huawei.hms.maps.HuaweiMapOptions.camera(org.xms.g.maps.model.CameraPosition): <a href="https://developer.huawei.com/consumer/en/doc/development/HMS-References/hms-map-huaweimapoptions#camera(CameraPosition)">https://developer.huawei.com/consumer/en/doc/development/HMS-References/hms-map-huaweimapoptions#camera(CameraPosition)</a><br/>
     * 
     ...
     * 
     * @return the return object is java.lang.Boolean
     */
     ...
     * 
     * @return the return object is java.lang.Float
     */
     ...
     * 
     * @param  param0 the param should instanceof maps.model.LatLngBounds
     * @return the return object is maps.ExtensionMapOptions
     */
    ...
    /**
     * org.xms.g.maps.ExtensionMapOptions.toString() toString<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
