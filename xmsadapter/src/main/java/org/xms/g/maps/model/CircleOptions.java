 ...
 * Combination of com.google.android.gms.maps.model.CircleOptions and com.huawei.hms.maps.model.CircleOptions.<br/>
...
public final class CircleOptions extends org.xms.g.utils.XObject {
    ...
    /**
     * org.xms.g.maps.model.CircleOptions.CircleOptions(org.xms.g.utils.XBox) constructor of CircleOptions<br/>
    ...
    /**
     * org.xms.g.maps.model.CircleOptions.CircleOptions() constructor of CircleOptions<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * 
     */
     ...
     * 
     * @param  param0 the param should instanceof double
     * @return the return object is maps.model.CircleOptions
     */
