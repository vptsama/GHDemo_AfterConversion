 ...
 * Combination of com.google.android.gms.maps.model.IndoorBuilding and com.huawei.hms.maps.model.IndoorBuilding.<br/>
...
public final class IndoorBuilding extends org.xms.g.utils.XObject {
    ...
    /**
     * org.xms.g.maps.model.IndoorBuilding.IndoorBuilding(org.xms.g.utils.XBox) constructor of IndoorBuilding<br/>
    ...
    /**
     * org.xms.g.maps.model.IndoorBuilding.getLevels() Gets the levels in the building. While a level is usually enclosed by a single building, a level might be enclosed by several buildings (e.g., a carpark level might span multiple buildings). The levels are in 'display order' from top to bottom.<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.model.IndoorBuilding.hashCode() hashCode<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
