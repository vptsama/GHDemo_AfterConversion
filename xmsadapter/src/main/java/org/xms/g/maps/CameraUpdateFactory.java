 ...
 * Combination of com.google.android.gms.maps.CameraUpdateFactory and com.huawei.hms.maps.CameraUpdateFactory.<br/>
...
public final class CameraUpdateFactory extends org.xms.g.utils.XObject {
     ...
     * 
     * @param  param0 float,
     * @param  param1 android.graphics.Point
     * @return the return object is maps.CameraUpdate
     */
    ...
    /**
     * org.xms.g.maps.CameraUpdateFactory.zoomIn() Increases the zoom level of the camera by 1.<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
    ...
    /**
     * org.xms.g.maps.CameraUpdateFactory.zoomOut() Decreases the zoom level of the camera by 1.<br/>
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
